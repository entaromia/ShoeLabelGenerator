...
namespace ImageSharpLabelGen.Helpers
{
    static class TextCalculator
    {
        ...
        /// </summary>
        public static string JoinKeyValuePair(KeyValuePair<string, int> pair) => $"{pair.Key}\n{pair.Value}";

        /// <summary>
        /// Calculates total text width of multiple string,string KeyValuePair 
        /// </summary>
        public static float TotalPairTextLength(List<KeyValuePair<string, int>> keyValuePairs, RichTextOptions textOptions, float padding = 0)
        {
            var width = 0F;
