...
namespace ImageSharpLabelGen
{
    public class ShoeData : INotifyPropertyChanged
    {
        ...
        public string SelectedBrand { get; set; } = "RIDGE";
        ...
        public string SelectedQuality { get; set; } = "SRC 01";

        public string Color { get; set; } = "GRİ SÜET";

        public string ReceiptNo { get; set; } = "2069";
